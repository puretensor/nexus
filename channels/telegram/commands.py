...
async def cmd_help(update: Update, context: ContextTypes.DEFAULT_TYPE):
    await update.message.reply_text(
        ...
        "/session &lt;name&gt; — Switch to or create session\n"
        ...
        "/forget &lt;text|n&gt; — Remove a memory\n"
        "/memories [topic|query] — List or search\n\n"
        "<b>Data Cards</b> (live image cards)\n"
        ...
        "  <i>5pm, tomorrow 9am, monday, daily 8am</i>\n"
        "/cancel &lt;n&gt; — Cancel task or reminder\n\n"
        "<b>Email &amp; Follow-ups</b>\n"
        "/drafts — Pending email reply drafts\n"
        "/followups — Active follow-ups\n"
        "/followups resolve &lt;n&gt; — Mark resolved\n\n"
        "<b>Calendar</b>\n"
        "/calendar [today|week|upcoming]\n\n"
        "<b>Infrastructure</b>\n"
        ...
        "/intel — Publish intelligence article\n\n"
        "/help — This message\n\n"
        "Send a location for context-aware responses.\n"
