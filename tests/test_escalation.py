...
class TestGetRemediationCommands:
    ...
    def test_returns_commands_for_instance(self):
        ...
        cmds = self.obs.get_remediation_commands("198.51.100.10:9100")
        assert isinstance(cmds, list)
        assert len(cmds) >= 3
        assert any("198.51.100.10" in c for c in cmds)
...
class TestSaveEscalationContext:
    ...
    def test_saves_json_with_correct_structure(self):
        ...
        down_nodes = [{"instance": "198.51.100.10:9100", "job": "node", "key": "test_key"}]
...
class TestEscalationCommandsCallback:
    ...
    async def test_commands_sends_list(self):
        ...
        update, ctx = _make_callback_query("escalation:commands:198.51.100.10:9100")
...
class TestEscalationFixCallback:
    ...
    async def test_fix_runs_ssh_restart(self):
        ...
        update, ctx = _make_callback_query("escalation:fix:198.51.100.10:9100")
